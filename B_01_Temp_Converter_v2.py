...
class Converter:
    ...
    def __init__(self):
        ...
        button_details_list = [
            ...
            ["To Fahrenheit", "#089980", lambda: self.check_temp(c.ABS_ZERO_CELSIUS), 0, 1],
    ...
    def check_temp(self, min_temp):
        ...
        # Reset label and entry box (if an error occurs)
    ...
    def to_help(self):
        """
        Opens help dialogue box and disabled help button (so that users can't create multiple help boxes
        """
        DisplayHelp(self)
...
class HistoryExport:
    ...
    def __init__(self, partner, calculations):
        ...
        export_instructions_txt = ("Please push <Export> to save your calculations in "
                                   "file. If the file name already exists, it will be replaced")
        calculations = ""
        ...
        # Retrieve export instruction level so that we can
        # confire it to show the filename if the user exports the file
    ...
    def export_data(self, calculations):
        ...
        with open(write_to, "w") as text_file:
            ...
            text_file.write("Here is your calculation hsitory (oldest to newest)...\n")
    ...
    def close_history(self, partner):
        """
        Closes History dialogue box (and enables Export / History button
        """

        # Put Export / History button back to normal...
